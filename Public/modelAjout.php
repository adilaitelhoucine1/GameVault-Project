...
<body class="bg-gradient-to-r from-purple-500 via-indigo-600 to-blue-500 text-gray-100 min-h-screen flex">
    ...
    <main class="flex-1 p-8 bg-white bg-opacity-80 rounded-tl-xl rounded-bl-xl shadow-lg animate-fade-in">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <h2 class="text-3xl font-semibold text-indigo-700 mb-6 text-center">Ajouter un Jeu</h2>

            <form action="" method="POST">
                <div class="mb-4">
                    <label for="title" class="block text-gray-700 font-medium">Titre du Jeu</label>
                    <input type="text" id="title" name="title" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" required>
                </div>

                <div class="mb-4">
                    <label for="description" class="block text-gray-700 font-medium">Description</label>
                    <textarea id="description" name="description" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" rows="4" required></textarea>
                </div>

                <div class="mb-4">
                    <label for="type" class="block text-gray-700 font-medium">Type du Jeu</label>
                    <input type="text" id="type" name="type" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" required>
                </div>

                <div class="mb-4">
                    <label for="nb_joueur" class="block text-gray-700 font-medium">Nombre de Joueurs</label>
                    <input type="number" id="nb_joueur" name="nb_joueur" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" required>
                </div>

                <div class="mb-4">
                    <label for="rating" class="block text-gray-700 font-medium">Note</label>
                    <input type="number" id="rating" name="rating" step="0.1" max="5" min="0" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="temps_jeu" name="temps_jeu" class="text-black w-full px-4 py-2 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-600" required>
                </div>
